...
@Autonomous(name="AutonomousIntake_BlueFarMap", group="Pushbot")
public class AutonomousIntake_BlueFarMap extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        drive(-PI / 2, 32, .4);
        rotate_arc(PI + PI* 25/180, .4);
        drive(0, distance, 0.4);
        sleep(100);
        diagonal();
        /*                         */
